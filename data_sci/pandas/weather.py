...
df.rename(columns = {'avg_precipitation': 'avg_rain'}, inplace=True)            # Rename 1 Column (Average Precipitation)

#header("10. df.columns = ['month','avg_hi','av_lo','rec_hi','rec_lo','av_rain']")
